        ...
        >
          <div className="relative bg-black/40 backdrop-blur-[30px] border border-white/10 rounded-[24px] p-8 sm:p-10 shadow-[0_24px_60px_rgba(0,0,0,0.6)] overflow-hidden group/card">
            ...
            <div className="text-center mb-8 relative z-20">
              <h2 className="font-fustat font-bold text-3xl text-white mb-2 tracking-tight">Welcome back</h2>
              <p className="font-inter text-gray-400">Login to continue</p>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-5 relative z-20">
              ...
              <div className="flex items-center justify-between mt-1 mb-2">
                <label className="flex items-center gap-2 cursor-pointer group/check">
                  ...
                  <span className="font-inter text-sm text-gray-300 select-none">Remember me</span>
                </label>
                <a href="#" className="font-inter text-sm text-blue-400 hover:text-blue-300 hover:underline font-medium transition-colors">Forgot password?</a>
              </div>
            ...
            <div className="flex items-center my-8 relative z-20">
              ...
              <span className="px-4 font-inter text-sm text-gray-500">or continue with</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <p className="mt-8 text-center font-inter text-sm text-gray-400 relative z-20">
              Don't have an account? <Link href="/signup" className="font-semibold text-blue-400 hover:text-blue-300 hover:underline transition-colors">Sign up</Link>
            </p>
          </div>
        </motion.div>
      </div>
